...
fn main(@builtin(global_invocation_id) invocation_id: vec3<u32>, @builtin(num_workgroups) num_workgroups: vec3<u32>) {
    set_vertex(0u, vec3<f32>(0.0, 5.0, 5.0));
    set_vertex(1u, vec3<f32>(0.0, -5.0, 5.0));
    set_vertex(2u, vec3<f32>(0.0, -5.0, -5.0));
    set_vertex(3u, vec3<f32>(0.0, 5.0, -5.0));
    set_vertex(4u, vec3<f32>(0.0, 5.0, 5.0));
    set_vertex(5u, vec3<f32>(0.0, -5.0, -5.0));
}
